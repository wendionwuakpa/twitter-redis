...
/**
 * Utils Class to establish a connection with the database
 */
public class DBUtils {
  ...
  /**
   * Constructs a DBUtils
   * @param url databse url connection
   * @param user username for the desired database
...
// interface outlines all methods rqeuried to query any database

// the classes that implement the interface run querries relevant to that specif db, e.g. we use mysql now
// but future we can add classes that use other dbs